...
public final class CompatUtil {
    ...
    private static final Logger LOGGER = Logger.getLogger("MATRIX-COREUTILS");
    ...
    public void setup() {
        LOGGER.info("Detected " + getRawVersion() + " server version.");
        switch (getMinorVersion()) {
            ...
            case 16:
                ...
                break;
            case 17:
                VERSION = MinecraftVersion.MINECRAFT_1_17;
                break;
            default:
                LOGGER.info("We don't have official support for: " + getRawVersion() + " using support for 1.17");
                VERSION = MinecraftVersion.MINECRAFT_1_17;
                break;
        }
    }
    ...
    private int getMinorVersion() {
        ...
        try {
            ...
            LOGGER.info("An error occurred getting server version, please contact developer.");
            LOGGER.info("Detected version " + ver);
        }
        return verInt;
    }
    ...
    public enum MinecraftVersion {
        ...
        public boolean isPrevOrEq(MinecraftVersion another) {
            return id <= another.id;
        }
    }
}
